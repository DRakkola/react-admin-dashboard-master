    ...
    <Box m="20px">
      ...
      >
        ...
        <Box
          gridColumn="span 8"
          gridRow="span 2"
          backgroundColor={colors.primary[400]} // You can adjust the value to control the roundness of the border
          sx={{
            border: "1px solid ",
            borderColor:borderColor, // Replace with your desired border color
            borderRadius: "10px", // Adjust the value to control the roundness of the border
        ...
        <Box
          ...
          padding="30px"
          sx={{
            border: "1px solid #e6ebf1", // Replace with your desired border color
            borderRadius: "10px", // Adjust the value to control the roundness of the border
